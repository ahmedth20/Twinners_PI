  ...
  return (
    <div className='bg-BodyBg-0 px-2 lg:px-[30px]'>
      <section className="bg-blue-900  bg-cover bg-center bg-no-repeat h-[600px] sm:h-[700px] md:h-[700px] lg:h-[700px] xl:h-[790px] 2xl:h-[790px] flex items-center relative z-10 overflow-hidden rounded-t-2xl md:rounded-t-[30px]">
        <div className=' bg-blue-900 absolute top-1/2 -translate-y-1/2 -left-14 xl:-left-10 hidden md:block'>
          <Link to={'/'}>
        ...
        <div className='bg-blue-900 flex justify-center items-center m-auto '>
        ...
        <div className='bg-blue-900 absolute top-1/2 -translate-y-1/2 right-5 xl:right-10 hidden md:block'>
          <ul className='bg-blue-900 flex flex-col items-center gap-[26px]'>
