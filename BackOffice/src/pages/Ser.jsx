...
import StaffList from "@widgets/Serlist";
import { 
...
const Paramedcs = () => {
 ...
 const [isTypePopupOpen, setIsTypePopupOpen] = useState(false);
  ...
  const handleAddStaff = async (e) => {
    ...
    try {
      await StaffService.createServiceManager(formData);
      alert("✅ service manager ajouté avec succès !");
  ...
  return (
    <Page title="Services managers List">
      <GlobalStyles />
      <Container>
